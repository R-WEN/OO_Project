...
public class DeleteTransCommand extends Command {
    ...
    public void Execute(MainPanelController controller) {
        ...
        System.out.println("DeleteTrans after statediagram:"+controller.getstateDiagram().getAlldiagram().size());
    }
